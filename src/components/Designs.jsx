...
import { desOne, desTwo, desThree, desFour } from '../utils';
...
The nut has to be loose but tight enough. And it works better horizontaly.</p>
          </div>
        </div>
        <div className="flex flex-col w-full relative">
          <div className="des-video-container">
          <p className="fil-text">This is a reminder for events or activities.

You can write your activity and set the time as the reminder.

To assemble the clock, follow the photos:

First, pull out the support behind the base and assemble with the base note.
Then put the 7 gears for the minutes and next the 45 teeth gear and the gears for the hours.

Then, put the arrow for hours and close all with the arrow for minute and the little disk behind.

I uploaded a 3mf with my settings.

I made it tight because I wanted it to stand on a fridge (so vertically).

Depending on the printer, if you need bigger gaps, fell free to contact me.

Size for the magnets: 10x2 mm (diameter x high).</p>

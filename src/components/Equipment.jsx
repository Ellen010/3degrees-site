    ...
    <section className="h-full common-padding relative overflow-hidden">
      <div className="screen-max-wdith g_fadeIn p:10">
        ...
        <div className="flex flex-col justify-center items-center overflow-hidden">
          ...
          <p className="txt-sm pt-30">The images presented that have been uploaded on this page are owned by the original Prusa and Bambu websites, and their intellectual property rights are fully respected.</p>
          </div>
        </div>
      </div>
    </section>
